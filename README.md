...
โปรเจกต์นี้คือการพัฒนาระบบ "Virtual Tactile Sensor" โดยการนำ Vision-Language Model (VLM) มาทำ System Integration ร่วมกับหุ่นยนต์แขนกลเพื่อตรวจจับการหยิบพลาด (Slippage) แบบ Real-time.
...
git clone [https://github.com/your-username/VLM-Grip.git](https://github.com/your-username/VLM-Grip.git)
cd VLM-Grip
